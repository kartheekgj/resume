...
});$("#hireMe").click(function(){window.open("./img/JAYENDRAKARTHEEK.pdf","_blank")
...
myApp.controller("mainController",function($scope){$scope.tabCompanies=[{name:"KRDS Pvt LTD",fromTo:"Mar ’14 – Jun ’14",urlParam:"krds",idParam:"krds"},{name:"BookMyShow",fromTo:"Jun ’12 – Mar ’14",urlParam:"bookmyshow",idParam:"bookmyshow"},{name:"ChangeRepublic.com",fromTo:"July’11 – July ’12",urlParam:"cr",idParam:"cr"}];
$scope.url="test.html"
});